    ...
    <div className="min-h-screen" style={{ background: '#7f56d9' }}>
      <div className="container mx-auto px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8 text-center">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-black mb-2">Esper Event Assistant</h1>
          <p className="text-black text-sm sm:text-lg">AI-powered event planning and lead management</p>
        </div>
